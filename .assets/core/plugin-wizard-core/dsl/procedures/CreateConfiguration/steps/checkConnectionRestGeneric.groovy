...
http.request(GET, JSON) { req ->
  headers.'User-Agent' = 'EF Check Connection'
  if (checkConnectionMeta.checkConnectionUri) {
  ...
  if (authType == "bearer") {
    def meta = checkConnectionMeta?.authSchemes?.bearer
